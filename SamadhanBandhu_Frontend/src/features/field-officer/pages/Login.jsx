...
import { Lock, Mail, ArrowRight, Key, Camera, CheckCircle, Clipboard } from 'lucide-react';
...
export default function Login() {
    ...
    const handleCredentialSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await api.post('/auth/verify-credentials', { email, password, role: 'field-officer' });
                ...
                <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-orange-600 font-semibold tracking-wide">PM-AJAY - FIELD OFFICER PORTAL</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h1 className="text-4xl font-bold text-gray-900 mb-4">
                                Welcome to <span className="text-blue-600">Field Officer Portal</span>
                            </h1>
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Conduct on-site inspections, verify project progress, submit inspection reports, and monitor construction quality under PM-AJAY.
                            </p>
                        </div>
                        ...
                        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg">
                            ...
                            <ul className="text-sm text-gray-700 space-y-1">
                                <li>✓ View assigned inspection schedules</li>
                                <li>✓ Conduct on-site project inspections</li>
                                <li>✓ Submit detailed inspection reports</li>
                                <li>✓ Upload geo-tagged photographs</li>
                                <li>✓ Verify construction quality and progress</li>
                            </ul>
                        </div>
                    ...
                    <div className="bg-white rounded-xl shadow-xl border border-gray-200 p-8">
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-2xl font-bold text-gray-900">Field Officer Login</h2>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="officer@field.gov.in"
                                    />
                                </div>
                            </div>
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200">
                            <p className="text-xs text-gray-500 text-center">
                                Need help? Contact your supervisor or call <strong>1800-111-6666</strong>
                            </p>
                        </div>
                    </div>
                </div>
