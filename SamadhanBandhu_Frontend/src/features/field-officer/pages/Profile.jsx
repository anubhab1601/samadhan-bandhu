...
export default function Profile() {
    ...
    const [profileData, setProfileData] = useState({
        ...
        // Official Details
        officerId: 'FO-MH-AHM-2024-001',
        employeeId: 'EMP-FO-12345',
            ...
            <div className="bg-gradient-to-r from-indigo-500 to-indigo-600 p-6 rounded-lg shadow-lg text-white">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-indigo-100">Manage your personal and official information</p>
                    </div>
                    {!isEditing ? (
                        <button
                            onClick={handleEdit}
                            className="flex items-center gap-2 px-4 py-2 bg-white text-indigo-600 rounded-lg hover:bg-indigo-50 font-semibold"
                        >
                            <Edit2 size={20} />
                            Edit Profile
                        </button>
                        ...
                        <div className="flex gap-2">
                            <button
                                onClick={handleSave}
                                className="flex items-center gap-2 px-4 py-2 bg-indigo-700 text-white rounded-lg hover:bg-indigo-800 font-semibold"
                            >
                                <Save size={20} />
                                Save
                            </button>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1">
                        ...
                        {isEditing && (
                            <button className="mt-3 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm font-semibold flex items-center gap-2">
                                <Upload size={16} />
                                Upload New Photo
                            </button>
                        )}
