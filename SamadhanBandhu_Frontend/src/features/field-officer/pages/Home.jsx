    ...
    return (
        <div className="space-y-4 md:space-y-6">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg md:rounded-xl p-4 md:p-8 shadow-lg">
                <h1 className="text-xl md:text-3xl font-bold mb-2">Welcome, {user.name || 'Field Officer'}!</h1>
                <p className="text-blue-100 text-sm md:text-base">Field Inspection Team</p>
                <p className="text-xs md:text-sm text-blue-200 mt-2">Conduct on-site inspections and submit detailed reports for ongoing projects</p>
            </div>
            ...
            <div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                    <StatCard title="Pending Inspections" value="8" icon={Clock} gradient="bg-gradient-to-br from-orange-500 to-orange-700" link="/inspections" />
                    <StatCard title="Completed Inspections" value="24" icon={CheckCircle} gradient="bg-gradient-to-br from-green-500 to-green-700" link="/inspections/completed" />
                    <StatCard title="Reports Submitted" value="24" icon={FileText} gradient="bg-gradient-to-br from-blue-500 to-blue-700" link="/reports" />
                    <StatCard title="Site Visits" value="32" icon={MapPin} gradient="bg-gradient-to-br from-purple-500 to-purple-700" link="/inspections" />
                </div>
            </div>
            ...
            <div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                    <Link to="/inspections" className="bg-white rounded-lg p-4 md:p-6 hover:shadow-lg shadow-sm transition-all">
                        ...
                        <h3 className="text-base md:text-lg font-bold text-gray-900 mb-1 md:mb-2">View Inspections</h3>
                        <p className="text-xs md:text-sm text-gray-600">Check pending inspection assignments</p>
                    </Link>
                    <Link to="/reports/submit" className="bg-white rounded-lg p-4 md:p-6 hover:shadow-lg shadow-sm transition-all">
                        ...
                        <p className="text-xs md:text-sm text-gray-600">Submit inspection report with photos</p>
                    </Link>
                    <Link to="/reports" className="bg-white rounded-lg p-4 md:p-6 hover:shadow-lg shadow-sm transition-all">
                        ...
                        <p className="text-xs md:text-sm text-gray-600">View all submitted inspection reports</p>
                    </Link>
                </div>
            </div>
                ...
                <div className="divide-y">
                    <div className="p-3 md:p-4 hover:bg-gray-50">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <p className="text-sm font-semibold text-gray-900">New Inspection Assigned</p>
                                <p className="text-xs md:text-sm text-gray-600 mt-1">Project PMAJAY-2025-MH-12345 assigned for field inspection</p>
                                <p className="text-xs text-gray-400 mt-1 md:mt-2">3 hours ago</p>
                            </div>
                        </div>
                    </div>
                    <div className="p-3 md:p-4 hover:bg-gray-50">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-xs md:text-sm text-gray-600 mt-1">Inspection report for Project XYZ submitted successfully</p>
