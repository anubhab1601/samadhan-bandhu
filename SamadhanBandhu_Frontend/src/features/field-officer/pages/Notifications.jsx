    ...
    const [notifications, setNotifications] = useState([
        {
            ...
            message: 'You have been assigned to inspect School Building Renovation project in Shirdi, Ahmednagar.',
        ...
        },
        {
            id: 2,
            type: 'change',
            title: 'Inspection Date Changed',
            message: 'The inspection date for Community Hall Construction has been rescheduled to December 5, 2025.',
        ...
        },
        {
            ...
            message: 'Reminder: Inspection for School Building Renovation is scheduled for tomorrow at 10:00 AM.',
            projectId: 'PROJ-2025-001',
            inspectionId: 'INS-2025-001',
        ...
        },
        {
            ...
            type: 'assignment',
            title: 'New Inspection Assigned',
            message: 'You have been assigned to inspect Water Supply System project in Pune Rural, Pune.',
        ...
        },
        {
            ...
            message: 'You have a pending inspection report for Road Development Project. Please submit it soon.',
            ...
            <div className="bg-gradient-to-r from-indigo-500 to-indigo-600 p-6 rounded-lg shadow-lg text-white">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-indigo-100">Stay updated with your inspection assignments</p>
                    </div>
                    {stats.unread > 0 && (
                        <button
                            onClick={markAllAsRead}
                            className="px-4 py-2 bg-white text-indigo-600 rounded-lg hover:bg-indigo-50 font-semibold"
                        >
                            Mark All as Read
                        </button>
                    )}
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    {notification.projectId && (
                                                        <p className="text-xs text-gray-500 mt-1">
                                                            Project: {notification.projectId} • Inspection: {notification.inspectionId}
                                                        </p>
                                                    )}
                                                </div>
                                            </div>
