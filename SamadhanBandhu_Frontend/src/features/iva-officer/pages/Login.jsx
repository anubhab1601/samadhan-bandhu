...
import { Lock, Mail, ArrowRight, Key, Camera, CheckCircle, FileCheck } from 'lucide-react';
...
export default function Login() {
    ...
    const handleCredentialSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await api.post('/auth/verify-credentials', { email, password, role: 'iva-officer' });
                ...
                <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-orange-600 font-semibold tracking-wide">PM-AJAY - IVA OFFICER PORTAL</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="space-y-6">
                        <div>
                            <h1 className="text-4xl font-bold text-gray-900 mb-4">
                                Welcome to <span className="text-blue-600">IVA Officer Portal</span>
                            </h1>
                            <p className="text-lg text-gray-600 leading-relaxed">
                                Verify village applications, conduct field assessments, validate documentation, and submit verification reports under PM-AJAY.
                            </p>
                        </div>
                        ...
                        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg">
                            ...
                            <ul className="text-sm text-gray-700 space-y-1">
                                ...
                                <li>✓ Conduct field verification visits</li>
                                <li>✓ Validate submitted documentation</li>
                                <li>✓ Submit verification reports</li>
                                <li>✓ Recommend approval or rejection</li>
                            </ul>
                        </div>
                    ...
                    <div className="bg-white rounded-xl shadow-xl border border-gray-200 p-8">
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-2xl font-bold text-gray-900">IVA Officer Login</h2>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="iva@verification.gov.in"
                                    />
                                </div>
                            </div>
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200">
                            <p className="text-xs text-gray-500 text-center">
                                Need help? Contact State Officer or call <strong>1800-111-7777</strong>
                            </p>
                        </div>
                    </div>
                </div>
