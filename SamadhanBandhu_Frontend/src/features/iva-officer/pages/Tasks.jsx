...
export default function Tasks() {
    ...
    const [tasks, setTasks] = useState([
        {
            id: 1,
            title: 'Complete verification report for Shirdi village',
            description: 'Submit detailed verification report with photos and assessment',
            priority: 'high',
            status: 'pending',
            dueDate: '2025-12-05',
            type: 'Village Verification',
            assignedBy: 'State Officer',
            completed: false
        },
        {
            id: 2,
            title: 'Site visit for Committee Verification - Daund',
            description: 'Conduct site visit and verify committee members',
            priority: 'high',
            status: 'in-progress',
            dueDate: '2025-12-03',
        ...
        {
            id: 3,
            title: 'Review agency documents for ABC Constructions',
            description: 'Check agency documents and submit compliance report',
            priority: 'medium',
            status: 'pending',
            dueDate: '2025-12-08',
        ...
        {
            id: 4,
            title: 'Upload geo-tagged photos for Nashik verification',
            description: 'Upload verification site photos with GPS coordinates',
            priority: 'medium',
            status: 'in-progress',
            dueDate: '2025-12-06',
            type: 'Documentation',
        ...
        {
            id: 5,
            title: 'Coordinate with sarpanch for next verification',
            description: 'Schedule and coordinate verification date with sarpanch',
            priority: 'low',
            status: 'pending',
            dueDate: '2025-12-10',
            type: 'Coordination',
        ...
        {
            id: 6,
            title: 'Submit monthly verification summary',
            description: 'Compile and submit monthly summary of all verifications',
            priority: 'high',
            status: 'completed',
            dueDate: '2025-11-30',
            type: 'Report',
    ...
    const taskTypes = ['All Types', 'Village Verification', 'Committee Verification', 'Agency Verification', 'Documentation', 'Coordination', 'Report'];
            ...
            <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-6 rounded-lg shadow-lg text-white">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-purple-100">Organize and track all your verification tasks</p>
                    </div>
                    <button
