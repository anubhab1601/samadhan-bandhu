    ...
    const [tasks, setTasks] = useState([
        {
            ...
            description: 'Compile and submit the monthly progress report for School Building project',
            priority: 'high',
            status: 'pending',
            dueDate: '2025-12-05',
        ...
        },
        {
            ...
            description: 'Place order for cement, steel, and bricks',
            priority: 'high',
            status: 'in-progress',
            dueDate: '2025-12-03',
            project: 'School Building Renovation',
        ...
        },
        {
            ...
            description: 'Coordinate with field officer for site inspection',
            priority: 'medium',
            status: 'pending',
            dueDate: '2025-12-08',
            project: 'School Building Renovation',
        ...
        {
            id: 4,
            title: 'Update worker attendance records',
            description: 'Update attendance for all workers for the current week',
            priority: 'medium',
            status: 'in-progress',
            dueDate: '2025-12-06',
            project: 'School Building Renovation',
        ...
        },
        {
            ...
            description: 'Conduct safety review and update protocols',
            priority: 'low',
            status: 'pending',
            dueDate: '2025-12-10',
            project: 'School Building Renovation',
        ...
        },
        {
            ...
            description: 'Finish the foundation work and prepare for next phase',
            priority: 'high',
            status: 'completed',
            dueDate: '2025-11-30',
            project: 'Village Community Center',
            assignedTo: 'Construction Lead',
            completed: true
        }
    ]);
            ...
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-6 rounded-lg shadow-lg text-white">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-orange-100">Organize and track all your project tasks</p>
                    </div>
                    <button
