                        ...
                        <div className="space-y-2">
                            <details className="group border border-gray-200 rounded-lg">
                                ...
                                <div className="p-3 pt-0 text-sm text-gray-600">
                                    Navigate to the "Projects" section and click on "New Project". Follow the wizard to submit your proposal.
                                </div>
                            </details>
                            <details className="group border border-gray-200 rounded-lg">
                                <summary className="flex justify-between items-center p-3 cursor-pointer text-sm font-medium text-gray-700 hover:bg-gray-50">
                                    Where can I check fund status?
                                    <span className="text-gray-400 group-open:rotate-180 transition-transform">▼</span>
                                </summary>
                                <div className="p-3 pt-0 text-sm text-gray-600">
                                    Go to the "Funds" tab in your dashboard to view real-time allocation and utilization status.
                                </div>
                            </details>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="space-y-2 text-sm">
                            <div className="flex items-center gap-2 text-gray-700">
                                ...
                                <span>support@samadhan.gov.in</span>
                            </div>
                            <div className="flex items-center gap-2 text-gray-700">
