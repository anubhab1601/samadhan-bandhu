...
export default function Notifications() {
    ...
    const [notifications, setNotifications] = useState([
        {
            ...
            message: 'Your application PMAJAY-2025-MH-12345 for Community Hall Construction has been forwarded to IVA for verification.',
        ...
        },
        {
            id: 2,
            type: 'iva-decision',
            title: 'IVA Verification Completed',
            message: 'IVA Officer has completed verification for your School Building project. Status: Approved',
    ...
    const getTypeIcon = (type) => {
        const config = {
            ...
            'iva-decision': { icon: CheckCircle, color: 'text-green-600', bg: 'bg-green-100' },
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <option value="iva-decision">IVA Decisions</option>
