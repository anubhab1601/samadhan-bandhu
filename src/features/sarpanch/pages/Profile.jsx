...
export default function Profile() {
    ...
    const [profileData, setProfileData] = useState({
        ...
        // Official Details
        sarpanchId: 'SARP-MH-AHM-2024-001',
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-gray-600">Sarpanch, {profileData.villageName}</p>
                        <p className="text-sm text-gray-500 mt-1">ID: {profileData.sarpanchId}</p>
                        {isEditing && (
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Sarpanch ID</label>
                        <p className="text-gray-900 font-semibold">{profileData.sarpanchId}</p>
                    </div>
                    <div>
