        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-6 rounded-lg shadow-lg text-white mb-6">
                    <h1 className="text-3xl font-bold mb-2">Sarpanch Registration</h1>
                    <p className="text-orange-100">Register as a Sarpanch to access PM-AJAY portal</p>
                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-500 ${errors.sarpanchId ? 'border-red-500' : 'border-gray-300'}`}
                                            placeholder="SARP-MH-AHM-2024-001"
                                        />
