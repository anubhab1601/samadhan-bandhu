                ...
                <div className="max-w-7xl mx-auto">
                    <ul className="flex items-center text-sm font-medium">
                        ...
                        <li className="relative">
                            ...
                            >
                                {t('nav_dashboard')} <ChevronDown size={16} />
                            </button>
                        ...
                        <li className="relative">
                            ...
                            {activeDropdown === 'projects' && (
                                <div className="absolute top-full left-0 bg-white text-gray-800 shadow-lg min-w-[200px] border border-gray-200 z-50">
                                    <Link to="/projects" className="block px-4 py-2 hover:bg-blue-50">{t('drop_all_projects')}</Link>
                                    <Link to="/projects/new" className="block px-4 py-2 hover:bg-blue-50">{t('drop_create_new')}</Link>
                                    <Link to="/projects/reports" className="block px-4 py-2 hover:bg-blue-50">{t('nav_reports')}</Link>
                                </div>
                            )}
                        </li>
                        ...
                        <li>
                            <Link to="/payments" className="block py-3.5 px-5 hover:bg-[#1565c0] transition-colors border-b-2 border-transparent hover:border-orange-400">
                                {t('nav_payments')}
                            </Link>
                        </li>
                        ...
                        <li className="relative">
                            ...
                            {activeDropdown === 'reports' && (
                                <div className="absolute top-full left-0 bg-white text-gray-800 shadow-lg min-w-[200px] border border-gray-200">
                                    <Link to="/reports/monthly" className="block px-4 py-2 hover:bg-blue-50">{t('drop_monthly')}</Link>
                                    <Link to="/reports/annual" className="block px-4 py-2 hover:bg-blue-50">{t('drop_annual')}</Link>
                                    <Link to="/reports/custom" className="block px-4 py-2 hover:bg-blue-50">{t('drop_custom')}</Link>
                                </div>
                            )}
                        </li>
