...
import { DollarSign, TrendingUp, Building2, Users, Filter, Search, Eye, Download, ChevronDown, ChevronRight, MapPin, Briefcase, FileText, AlertCircle, CheckCircle, Clock } from 'lucide-react';
...
export default function FundManagement() {
    ...
    const [viewMode, setViewMode] = useState('hierarchy'); // 'hierarchy', 'components', 'agencies'

    // Mock data - Centre total budget
    const centreBudget = {
        total: 30000, // 300 Cr
        allocated: 27000, // 270 Cr (90%)
        utilized: 18500, // 185 Cr
        available: 3000, // 30 Cr
    };

    // Mock data - States with fund allocation
    const statesData = [
        {
            id: 1,
            name: 'Maharashtra',
                    ...
                    blocks: [
                        {
                            ...
                            utilized: 75,
                            components: {
                                adarshgram: { allocated: 40, utilized: 30, projects: 5 },
                                grantInAid: { allocated: 35, utilized: 28, projects: 8 },
                                hosteller: { allocated: 25, utilized: 17, projects: 12 }
                            },
                            agencies: [
                                { id: 1, name: 'Rural Development Agency', component: 'adarshgram', allocated: 40, utilized: 30, status: 'active' },
                                { id: 2, name: 'Education Support Foundation', component: 'grantInAid', allocated: 35, utilized: 28, status: 'active' },
                                { id: 3, name: 'Student Welfare Trust', component: 'hosteller', allocated: 25, utilized: 17, status: 'active' }
                            ]
                        },
                        {
                            id: 2,
                            ...
                            utilized: 60,
                            components: {
                                adarshgram: { allocated: 30, utilized: 22, projects: 4 },
                                grantInAid: { allocated: 28, utilized: 20, projects: 6 },
                                hosteller: { allocated: 22, utilized: 18, projects: 9 }
                            },
                            agencies: [
                                { id: 4, name: 'Tribal Development Corp', component: 'adarshgram', allocated: 30, utilized: 22, status: 'active' },
                                { id: 5, name: 'Skill Training Institute', component: 'grantInAid', allocated: 28, utilized: 20, status: 'active' }
                            ]
                        }
                    ]
                },
                    ...
                    blocks: [
                        {
                            ...
                            utilized: 120,
                            components: {
                                adarshgram: { allocated: 50, utilized: 40, projects: 6 },
                                grantInAid: { allocated: 55, utilized: 45, projects: 10 },
                                hosteller: { allocated: 45, utilized: 35, projects: 15 }
                            },
                            agencies: [
                                { id: 6, name: 'Urban Development Agency', component: 'adarshgram', allocated: 50, utilized: 40, status: 'active' },
                                { id: 7, name: 'Community Education Trust', component: 'grantInAid', allocated: 55, utilized: 45, status: 'active' },
                                { id: 8, name: 'Hostel Management Board', component: 'hosteller', allocated: 45, utilized: 35, status: 'active' }
                            ]
                        }
                    ]
                }
                    ...
                    blocks: [
                        {
                            ...
                            utilized: 150,
                            components: {
                                adarshgram: { allocated: 70, utilized: 52, projects: 7 },
                                grantInAid: { allocated: 75, utilized: 58, projects: 12 },
                                hosteller: { allocated: 55, utilized: 40, projects: 18 }
                            },
                            agencies: [
                                { id: 9, name: 'Gujarat Rural Board', component: 'adarshgram', allocated: 70, utilized: 52, status: 'active' },
                                { id: 10, name: 'Educational Aid Society', component: 'grantInAid', allocated: 75, utilized: 58, status: 'active' }
                            ]
                        }
                    ]
                }
                    ...
                    blocks: [
                        {
                            ...
                            utilized: 135,
                            components: {
                                adarshgram: { allocated: 60, utilized: 45, projects: 5 },
                                grantInAid: { allocated: 65, utilized: 50, projects: 9 },
                                hosteller: { allocated: 55, utilized: 40, projects: 14 }
                            },
                            agencies: [
                                { id: 11, name: 'Karnataka Development Agency', component: 'adarshgram', allocated: 60, utilized: 45, status: 'active' }
                            ]
                        }
                    ]
                }
    ...
    const getComponentSummary = () => {
        const summary = {
            adarshgram: { allocated: 0, utilized: 0, projects: 0 },
            grantInAid: { allocated: 0, utilized: 0, projects: 0 },
            hosteller: { allocated: 0, utilized: 0, projects: 0 }
        };
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white border-l-4 border-l-blue-600 p-4 rounded-r-lg shadow-sm">
                <h1 className="text-2xl font-bold text-gray-900">Hierarchical Fund Management</h1>
                <p className="text-sm text-gray-600 mt-1">
                    Centre → States → Districts → Blocks | Track PM-AJAY components and working agencies
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl p-6 text-white shadow-lg">
                    ...
                    <div className="text-xs opacity-90">30 States | 90 Districts | 270 Blocks</div>
                </div>
                ...
                {viewMode === 'analytics' && (
                    <div className="p-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white border border-gray-200 rounded-lg p-6">
                                <h3 className="text-lg font-bold text-gray-800 mb-4">State-wise Fund Allocation</h3>
                                <ResponsiveContainer width="100%" height={300}>
