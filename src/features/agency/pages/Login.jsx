...
import { Lock, Mail, ArrowRight, Key, Camera, CheckCircle, Building2 } from 'lucide-react';
...
export default function Login() {
    ...
    const handleCredentialSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await api.post('/auth/verify-credentials', { email, password, role: 'agency' });
                ...
                <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-orange-600 font-semibold tracking-wide">PM-AJAY - AGENCY PORTAL</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="space-y-6">
                        <div>
                            <h1 className="text-4xl font-bold text-gray-900 mb-4">
                                Welcome to <span className="text-blue-600">Agency Portal</span>
                            </h1>
                        ...
                        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg">
                            ...
                            <ul className="text-sm text-gray-700 space-y-1">
                                <li>✓ View assigned construction projects</li>
                                <li>✓ Submit progress reports and updates</li>
                                <li>✓ Request fund releases</li>
                                <li>✓ Upload project documentation</li>
                                <li>✓ Coordinate with field officers</li>
                            </ul>
                        </div>

                        <div className="bg-orange-50 border-l-4 border-orange-500 p-4 rounded-r-lg">
                            <p className="text-sm text-gray-700">
                                <strong>Note:</strong> Only verified agencies can access this portal. Contact your State Officer for registration.
                            </p>
                        </div>
                    ...
                    <div className="bg-white rounded-xl shadow-xl border border-gray-200 p-8">
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200">
                            <p className="text-xs text-gray-500 text-center">
                                Need registration? Contact your State Officer or call <strong>1800-111-6666</strong>
                            </p>
                        </div>
                    </div>
                </div>
