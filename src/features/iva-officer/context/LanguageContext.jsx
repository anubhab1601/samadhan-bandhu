...
const translations = {
    en: {
        ...
        platform_name: 'PM-AJAY - IVA Portal',
        nav_home: 'Home',
        ...
        nav_reports: 'Reports',
        nav_help: 'Help',
        drop_pending_assignments: 'Pending Assignments',
        drop_completed_verifications: 'Completed Verifications',
    ...
    hi: {
        ...
        platform_name: 'पीएम-अजय (आदर्श ग्राम) - IVA पोर्टल',
        nav_home: 'होम',
        ...
        nav_reports: 'रिपोर्ट',
        nav_help: 'सहायता',
        drop_pending_assignments: 'लंबित असाइनमेंट',
        drop_completed_verifications: 'पूर्ण सत्यापन',
