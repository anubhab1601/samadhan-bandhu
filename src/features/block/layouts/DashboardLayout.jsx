                    ...
                    <ul className="flex items-center text-sm font-medium">
                        ...
                        <li className="relative">
                            ...
                            {activeDropdown === 'applications' && (
                                <div className="absolute top-full left-0 bg-white text-gray-800 shadow-lg min-w-[200px] border border-gray-200 z-50">
                                    <Link to="/applications/new" className="block px-4 py-2 hover:bg-blue-50">{t('drop_new_application')}</Link>
                                    <Link to="/applications" className="block px-4 py-2 hover:bg-blue-50">{t('drop_my_applications')}</Link>
                                    <Link to="/applications/track" className="block px-4 py-2 hover:bg-blue-50">{t('drop_track_status')}</Link>
                                </div>
                            )}
                        </li>
                        ...
                        <li className="relative">
                            ...
                            {activeDropdown === 'tenders' && (
                                <div className="absolute top-full left-0 bg-white text-gray-800 shadow-lg min-w-[200px] border border-gray-200 z-50">
                                    <Link to="/tenders" className="block px-4 py-2 hover:bg-blue-50">{t('drop_active_tenders')}</Link>
                                    <Link to="/tenders/release" className="block px-4 py-2 hover:bg-blue-50">{t('drop_release_tender')}</Link>
                                    <Link to="/tenders/applications" className="block px-4 py-2 hover:bg-blue-50">{t('drop_tender_applications')}</Link>
                                </div>
                            )}
                        </li>
