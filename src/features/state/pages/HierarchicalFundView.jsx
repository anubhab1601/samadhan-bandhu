...
import { DollarSign, TrendingUp, Building2, Users, Filter, Search, Eye, Download, ChevronDown, ChevronRight, MapPin, Briefcase, FileText, CheckCircle, Clock } from 'lucide-react';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, PieChart, Pie, Cell } from 'recharts';

const COLORS = ['#3b82f6', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6'];

export default function HierarchicalFundView() {
    ...
    const [viewMode, setViewMode] = useState('hierarchy'); // 'hierarchy', 'agencies', 'analytics'

    // Mock data - State budget (e.g., Maharashtra)
    const stateBudget = {
        total: 1000, // 10 Cr allocated from Centre
        allocated: 900, // 9 Cr distributed to districts
        utilized: 675, // 6.75 Cr
        available: 100, // 1 Cr
    };

    // Mock data - Districts with fund allocation
    const districtsData = [
        {
            id: 1,
            name: 'Pune',
            ...
            blocks: [
                {
                    ...
                    utilized: 75,
                    components: {
                        adarshgram: { allocated: 40, utilized: 30, projects: 5, beneficiaries: 250 },
                        grantInAid: { allocated: 35, utilized: 28, projects: 8, beneficiaries: 180 },
                        hosteller: { allocated: 25, utilized: 17, projects: 12, beneficiaries: 320 }
                    },
                    agencies: [
                ...
                },
                {
                    ...
                    utilized: 60,
                    components: {
                        adarshgram: { allocated: 30, utilized: 22, projects: 4, beneficiaries: 200 },
                        grantInAid: { allocated: 28, utilized: 20, projects: 6, beneficiaries: 150 },
                        hosteller: { allocated: 22, utilized: 18, projects: 9, beneficiaries: 240 }
                    },
                    agencies: [
                        ...
                        { id: 6, name: 'Hostel Management Board', component: 'hosteller', allocated: 22, utilized: 18, status: 'active', projects: 9 }
                    ]
                },
                {
                    id: 3,
                    ...
                    utilized: 90,
                    components: {
                        adarshgram: { allocated: 45, utilized: 34, projects: 6, beneficiaries: 280 },
                        grantInAid: { allocated: 42, utilized: 32, projects: 9, beneficiaries: 200 },
                        hosteller: { allocated: 33, utilized: 24, projects: 14, beneficiaries: 360 }
                    },
                    agencies: [
                        { id: 7, name: 'Village Development Society', component: 'adarshgram', allocated: 45, utilized: 34, status: 'active', projects: 6 },
                        { id: 8, name: 'Educational Aid Trust', component: 'grantInAid', allocated: 42, utilized: 32, status: 'active', projects: 9 }
                    ]
                }
            ]
        },
            ...
            blocks: [
                {
                    ...
                    utilized: 120,
                    components: {
                        adarshgram: { allocated: 50, utilized: 40, projects: 6, beneficiaries: 300 },
                        grantInAid: { allocated: 55, utilized: 45, projects: 10, beneficiaries: 220 },
                        hosteller: { allocated: 45, utilized: 35, projects: 15, beneficiaries: 400 }
                    },
                    agencies: [
                        { id: 9, name: 'Urban Development Agency', component: 'adarshgram', allocated: 50, utilized: 40, status: 'active', projects: 6 },
                        { id: 10, name: 'Community Education Trust', component: 'grantInAid', allocated: 55, utilized: 45, status: 'active', projects: 10 },
                        { id: 11, name: 'Hostel Management Board', component: 'hosteller', allocated: 45, utilized: 35, status: 'active', projects: 15 }
                    ]
                },
                {
                    id: 5,
                    ...
                    utilized: 100,
                    components: {
                        adarshgram: { allocated: 45, utilized: 35, projects: 5, beneficiaries: 260 },
                        grantInAid: { allocated: 48, utilized: 38, projects: 8, beneficiaries: 190 },
                        hosteller: { allocated: 37, utilized: 27, projects: 12, beneficiaries: 330 }
                    },
                    agencies: [
                        { id: 12, name: 'Social Welfare Agency', component: 'adarshgram', allocated: 45, utilized: 35, status: 'active', projects: 5 },
                        { id: 13, name: 'Education Development Board', component: 'grantInAid', allocated: 48, utilized: 38, status: 'active', projects: 8 }
                    ]
                }
            ]
        },
            ...
            blocks: [
                {
                    ...
                    utilized: 65,
                    components: {
                        adarshgram: { allocated: 38, utilized: 25, projects: 4, beneficiaries: 220 },
                        grantInAid: { allocated: 35, utilized: 22, projects: 7, beneficiaries: 160 },
                        hosteller: { allocated: 27, utilized: 18, projects: 10, beneficiaries: 280 }
                    },
                    agencies: [
                        { id: 14, name: 'Nashik Development Corp', component: 'adarshgram', allocated: 38, utilized: 25, status: 'active', projects: 4 },
                        { id: 15, name: 'Tribal Education Society', component: 'grantInAid', allocated: 35, utilized: 22, status: 'active', projects: 7 }
                    ]
                }
            ]
        }
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white border-l-4 border-l-green-600 p-4 rounded-r-lg shadow-sm">
                <h1 className="text-2xl font-bold text-gray-900">Hierarchical Fund Management - State Level</h1>
                <p className="text-sm text-gray-600 mt-1">
                    State → Districts → Blocks | Track PM-AJAY components and working agencies
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="bg-gradient-to-br from-green-500 to-green-700 rounded-xl p-6 text-white shadow-lg">
                    ...
                    <div className="text-xs opacity-90">{districtsData.length} Districts | {districtsData.reduce((sum, d) => sum + d.blocks.length, 0)} Blocks</div>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-md border border-gray-200">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="text-right">
                            <p className="text-xs text-gray-500 uppercase tracking-wider">Allocated</p>
                ...
                <div className="border-b border-gray-200">
                    <nav className="flex gap-4 px-6">
                        <button
                            ...
                            className={`py-4 px-2 border-b-2 font-medium text-sm transition-colors ${viewMode === 'hierarchy'
                        ...
                        <button
                            ...
                            className={`py-4 px-2 border-b-2 font-medium text-sm transition-colors ${viewMode === 'agencies'
                                    ? 'border-green-600 text-green-600'
                                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                }`}
                        >
                            Working Agencies ({allAgencies.length})
                        </button>
                        <button
                            onClick={() => setViewMode('analytics')}
                            className={`py-4 px-2 border-b-2 font-medium text-sm transition-colors ${viewMode === 'analytics'
                                    ? 'border-green-600 text-green-600'
                                    : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                }`}
                        >
                    ...
                    <div className="p-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="bg-white border border-gray-200 rounded-lg p-6">
                                <h3 className="text-lg font-bold text-gray-800 mb-4">Component-wise Fund Distribution</h3>
                                <ResponsiveContainer width="100%" height={300}>
                                    <PieChart>
                                        <Pie
                                            data={[
                                                { name: 'Adarshgram', value: componentSummary.adarshgram.allocated },
                                                { name: 'Grant-in-Aid', value: componentSummary.grantInAid.allocated },
                                                { name: 'Hosteller', value: componentSummary.hosteller.allocated }
                                            ]}
                                            cx="50%"
                                            cy="50%"
                                            labelLine={false}
                            ...
                            <div className="bg-white border border-gray-200 rounded-lg p-6">
                                <h3 className="text-lg font-bold text-gray-800 mb-4">District-wise Fund Allocation</h3>
                                <ResponsiveContainer width="100%" height={300}>
                                    <BarChart data={getFilteredData()}>
                                        ...
                                        <Tooltip />
                                        <Legend />
                                        <Bar dataKey="allocated" fill="#3b82f6" name="Allocated (Lakh)" />
                                        <Bar dataKey="utilized" fill="#10b981" name="Utilized (Lakh)" />
                                    </BarChart>
                                </ResponsiveContainer>
                            </div>
                        </div>
